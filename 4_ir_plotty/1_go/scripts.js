...
var headers = $("#gridHolder0").find(".x-column-header-text");

var rez = $("#gridHolder0").find(".x-column-header-text").map(
  function(i, v) {
    // console.log(i);
    // console.log($(v).text());
    return (i, $(v).text());
...
var rowData = $("#gridHolder0").find(".x-grid-row");

var w = $("#gridHolder0").find(".x-grid-row").map(
  function(i, v) {
    // console.log('i:' +  i);
